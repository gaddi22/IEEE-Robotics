...
void setup() {
  ...
  if (tcs.begin()) {                                              //if the sensor starts correctly
    ...
    while (1); // halt!    //what does this do?
  }
...
void loop(){
  ...
  String color = colorSense();      //Sloke: what is the purpose of colorSense?
...
String colorSense() {
  ...
  //TESTING
  Serial.println(classifyColor((int)r,(int)g,(int)b));
...
String classifyColor(int r, int g, int b) {
  ...
  Serial.println("Display Distance Arra");
  for( int index = 0; index < 9; index++){
    Serial.print(dArr[index]);
    Serial.print(" ");
    }
  Serial.println();
